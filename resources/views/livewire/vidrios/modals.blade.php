            ...
            <div class="modal-content">
                <div class="cardPrin" style="cursor: move;">
                    <div class="cardPrin-header d-flex justify-content-between align-items-center">
                        <h5 class="m-0">
                            {{ $selected_id ? 'Editar Vidrio' : 'Crear Vidrio' }}
                        </h5>
                    ...
                    <div class="cardPrin-body" style="padding: 0 20px; max-height: 400px; overflow-y: auto;">
                        <form>
                            <div class="row">
                                ...
                                @endif
                                <div class="col-md-6">
                                    <label for="vidrio" class="etiBase">Vidrio</label>
                                    <input wire:model="vidrio" type="text" class="inpBase" id="vidrio">@error('vidrio') <span class="error text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="col-md-6">
                                    <label for="grosor" class="etiBase">Grosor</label>
                                    <input wire:model="grosor" type="text" class="inpBase" id="grosor">@error('grosor') <span class="error text-danger">{{ $message }}</span> @enderror
                                </div>
</div></form>
                    </div>
