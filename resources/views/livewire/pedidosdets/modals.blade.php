            ...
            <div class="modal-content">
                <div class="cardPrin" style="cursor: move;">
                    <div class="cardPrin-header d-flex justify-content-between align-items-center">
                        <h5 class="m-0">
                            {{ $selected_id ? 'Editar Pedidosdet' : 'Crear Pedidosdet' }}
                        </h5>
                    ...
                    <div class="cardPrin-body" style="padding: 0 20px; max-height: 400px; overflow-y: auto;">
                        <form>
                            <div class="row">
                                ...
                                @endif
                                <div class="col-md-6">
                                    <label for="IdPedido" class="etiBase">Idpedido</label>
                                    <input wire:model="IdPedido" type="text" class="inpBase" id="IdPedido">@error('IdPedido') <span class="error text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="col-md-6">
                                    <label for="IdProducto" class="etiBase">Idproducto</label>
                                    <input wire:model="IdProducto" type="text" class="inpBase" id="IdProducto">@error('IdProducto') <span class="error text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="col-md-6">
