            ...
            <div class="modal-content">
                <div class="cardPrin">
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model.live="tipo" type="text" class="inpBase" id="tipo">@error('tipo') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="orden" class="etiBase">Orden</label>
                        <input wire:model.live="orden" type="text" class="inpBase" id="orden">@error('orden') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
</form>
                    </div>
