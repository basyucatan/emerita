            ...
            <div class="modal-content">
                <div class="cardPrin" style="cursor: move;">
                    <div class="cardPrin-header d-flex justify-content-between align-items-center">
                        <h5 class="m-0">
                            {{ $selected_id ? 'Editar Guia' : 'Crear Guia' }}
                        </h5>
                    ...
                    <div class="cardPrin-body" style="padding: 0 20px; max-height: 400px; overflow-y: auto;">
                        <form>
                            <div class="row">
                                ...
                                @endif
                                <div class="col-md-6">
                                    <label for="guia" class="etiBase">Guia</label>
                                    <input wire:model="guia" type="text" class="inpBase" id="guia">@error('guia') <span class="error text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="col-md-6">
                                    <label for="IdMaterial" class="etiBase">Idmaterial</label>
                                    <input wire:model="IdMaterial" type="text" class="inpBase" id="IdMaterial">@error('IdMaterial') <span class="error text-danger">{{ $message }}</span> @enderror
                                </div>
</div></form>
                    </div>
