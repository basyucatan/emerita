            ...
            <div class="modal-content">
                <div class="cardPrin" style="cursor: move;">
                    <div class="cardPrin-header d-flex justify-content-between align-items-center">
                        <h5 class="m-0">
                            {{ $selected_id ? 'Editar Negociosdiv' : 'Crear Negociosdiv' }}
                        </h5>
                        ...
                        <form>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input wire:model="division" type="text" class="inpBase" id="division">@error('division') <span class="error text-danger">{{ $message }}</span> @enderror
                                </div>
</div></form>
                    </div>
