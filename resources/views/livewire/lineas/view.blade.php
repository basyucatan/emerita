            ...
            <div class="cardPrin">
                <div class="cardPrin-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="bot botVerde" wire:click="create" title="Nuevo Linea">
                            <i class="bi bi-file-earmark-plus"></i>
                        </div>
                    </div>
                </div>
                <div class="cardPrin-body">
                    @include('livewire.lineas.modals')
                        ...
                        <table class="table tabBase">
                            ...
                            <tbody>
                                @forelse($lineas as $row)
                                    <tr>
                                        <td>{{ $row->Division->division ?? null }}</td>
                                        <td>{{ $row->Marca->marca }}</td>
                                        <td>{{ $row->Colorable->colorable ?? null }}</td>
                                        <td>{{ $row->linea }}</td>
                                        <td>{{ $row->orden }}</td>
                                        <td width="120">
